...
class QtFinder(ABC):
    ...
    def find_frame(self, name: str) -> Optional[QFrame]:
        return QtFinder.find_widget(self.window, QFrame, name)
    ...
    def find_push_button(self, name: str) -> Optional[QPushButton]:
        return QtFinder.find_widget(self.window, QPushButton, name)
    ...
    def find_text_edit(self, name: str) -> Optional[QLineEdit]:
        return QtFinder.find_widget(self.window, QTextEdit, name)
